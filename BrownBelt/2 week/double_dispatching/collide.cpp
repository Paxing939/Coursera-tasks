...
public:
  explicit Building(geo2d::Rectangle geometry) : rectangle_(geometry) {}
...
public:
  explicit Fence(geo2d::Segment geometry) : segment_(geometry) {}
...
bool Unit::CollideWith(const Building &that) const {
  return geo2d::Collide(position_, that.GetRectangle());
}

bool Unit::CollideWith(const Tower &that) const {
  return geo2d::Collide(position_, that.GetCircle());
}

bool Unit::CollideWith(const Fence &that) const {
  return geo2d::Collide(position_, that.GetSegment());
}
...
bool Building::CollideWith(const Building &that) const {
  return geo2d::Collide(rectangle_, that.GetRectangle());
}

bool Building::CollideWith(const Tower &that) const {
  return geo2d::Collide(rectangle_, that.GetCircle());
}

bool Building::CollideWith(const Fence &that) const {
  return geo2d::Collide(rectangle_, that.GetSegment());
}
