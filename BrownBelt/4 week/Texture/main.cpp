...
void TestSmallTexture_2() {
  Canvas canvas;
  canvas.SetSize({6, 4});

  canvas.AddShape(ShapeType::Rectangle, {1, 1}, {4, 2},
                  MakeTextureSolid({4, 2}, '*'));
...
void TestSmallTexture_3() {
  Canvas canvas;
  canvas.SetSize({6, 4});

  canvas.AddShape(ShapeType::Rectangle, {1, 1}, {5, 3},
                  MakeTextureSolid({5, 3}, '*'));
...
void TestEllipse() {
  ...
  canvas.AddShape(ShapeType::Ellipse, {1, 0}, {4, 4},
                  MakeTextureSolid({4, 4}, '*'));
...
void TestEllipse_2() {
  ...
  canvas.AddShape(ShapeType::Ellipse, {1, 1}, {1, 1},
                  MakeTextureSolid({4, 4}, '*'));
...
void TestEllipse_3() {
  ...
  canvas.AddShape(ShapeType::Ellipse, {1, 1}, {2, 2},
                  MakeTextureSolid({4, 4}, '*'));
...
void TestOutOfImage() {
  ...
  canvas.AddShape(ShapeType::Rectangle, {1, 1}, {10, 2},
                  MakeTextureSolid({10, 4}, '*'));
...
int main() {
  ...
  RUN_TEST(tr, TestSmallTexture_2);
  RUN_TEST(tr, TestSmallTexture_3);
  RUN_TEST(tr, TestEllipse);
  RUN_TEST(tr, TestEllipse_2);
  RUN_TEST(tr, TestEllipse_3);
  RUN_TEST(tr, TestOutOfImage);
  return 0;
}